...
const report={generatedAt:artifactGeneratedAt(),dataset:"v5-probe-performance-v1",passed:ioBound.passed&&noInjectedDelay.passed,modelPolicy:"none",ioBound,noInjectedDelay};
