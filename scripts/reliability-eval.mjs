...
const passed=results.length===3&&results.every(r=>r.passed);console.log(JSON.stringify({generatedAt:artifactGeneratedAt(),dataset:RELIABILITY_DATASET,provider:"faux",liveEvidence:false,randomPolicy:"deterministic observations; random isolated IDs/ports",passed,results},null,2));if(!passed)process.exitCode=1;
