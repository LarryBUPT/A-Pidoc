...
const files = ["dist/test/pi-loop-contract.test.js", "dist/test/approval-contract.test.js", "dist/test/workspace-evidence.test.js", "dist/test/api-tool-bundles.test.js"];
const results = [];
