...
当前版本以 `package.json` 为准，测试总数以本轮实际输出为准；V5功能、性能与发布证据见 [v0.18.0发布审计](v5-performance-release-audit.md)。`v0.17.0` 的164项总测试、20项专项三轮与最终04真实模型验收保留在 [V5历史发布审计](v5-release-audit.md)。V4.5 `v0.16.0` 的144项测试、54条配对与最终07 live保持 [历史发布审计](v45-release-audit.md) 原证据；分批合同见 [Harness迁移文档](agentic-harness.md)，V4的83项行为基线保留。
