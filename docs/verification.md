...
当前V5正式受控版本 `v0.17.0` 有164项总测试、20项专项三轮与最终04真实模型验收，见 [V5发布审计](v5-release-audit.md)。V4.5 `v0.16.0` 的144项测试、54条配对与最终07 live保持 [历史发布审计](v45-release-audit.md) 原证据；分批合同见 [Harness迁移文档](agentic-harness.md)，V4的83项行为基线保留，测试总数以实际输出为准。
...
`v0.10.1` 的V3基线是75项；V4为83项，V4.5为144项，V5为164项。不能把历史数字写成永久门槛。
